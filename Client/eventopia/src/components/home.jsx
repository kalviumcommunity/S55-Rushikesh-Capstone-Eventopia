...
function Home() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setIsLoading(false); // Update loading state when data fetching completes
      }
    };
  ...
  return (
    <>
      {isLoading && <div className="loading">Loading...</div>} {/* Show loading indicator while data is being fetched */}
